...
class ChatHandler(EndpointHandler[ChatInputData]):
    ...
    @classmethod
    def payload_cls(cls) -> Type[ChatInputData]:
        return ChatInputData

    def make_benchmark_payload(self) -> ChatInputData:
        return ChatInputData.for_test()
